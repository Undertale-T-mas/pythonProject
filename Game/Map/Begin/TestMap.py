...
class MapTEST0(TileMap):
    def __init__(self):
        ...
        self.set_tile(0, 5, Tile(TileLibrary.iron_t))
        self.set_tile(1, 5, Tile(TileLibrary.iron_t))
        self.set_tile(4, 5, Tile(TileLibrary.iron_t))
        self.set_tile(5, 5, Tile(TileLibrary.iron_t))
        self.set_tile(8, 8, Tile(TileLibrary.iron_t))
        self.set_tile(9, 8, Tile(TileLibrary.iron_t))
        self.set_tile(12, 8, Tile(TileLibrary.iron_cr))
        self.set_tile(12, 7, Tile(TileLibrary.iron_inner))
        self.set_tile(12, 6, Tile(TileLibrary.iron_inner))
        self.set_tile(12, 5, Tile(TileLibrary.iron_cl))
        ...
        self.add_background('City\\2.png', 0.02, 0.7)
        self.add_background('City\\3.png', 0.06, 0.7)
        self.add_background('City\\4.png', 0.2, 0.7)
